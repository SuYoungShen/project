<?php
  ...
  function PlaceIn($placeName,$viewpoint,$attractions,$arrival,$picname,$path,$datetime)
  {
  ...
  function test($placeName,$viewpoint,$attractions,$arrival)
  {
    $placeIn ="INSERT INTO `place`
                          (`place`,`viewpoint`,`attractions`,`arrival`)
                          VALUES
                          (
                            '".$placeName."',
                            '".$viewpoint."',
