...
CREATE TABLE `member` (
  ...
  `emai` varchar(36) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `member` (`account`, `password`, `emai`, `name`, `datetime`) VALUES
('', '', '', '', '0000-00-00 00:00:00');
...
CREATE TABLE `slider` (
  ...
  `path` char(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `datetime` datetime NOT NULL
