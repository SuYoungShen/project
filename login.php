...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<script type="text/javascript" src="bc/assets/js/jquery.js"></script>
		<link rel="stylesheet" href="bc/assets/css/ace.min.css" />
		<!--[if lte IE 9]>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">旅遊網站</span>
								</h1>
											...
											<form class="form-horizontal" role="form">
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="button" name="registered" class="width-65 pull-right btn btn-sm btn-success">
